...
<?php
echo "<b>Chào Bạn ".$_SESSION['ses_MSSV'];echo "</b>"
?>
</div>
<style type="text/css">
#menu ul{
...
<div id="menu" >
    	...
    	<ul>
        	<li><a href="sinhvien/xemdiemsv.php">Xem Điểm</a></li>
			<li><a href="hocsinh/hocsinh_xemthongtin.php">Thông Tin Sinh Viên</a></li>
